#!/bin/bash
#SBATCH --job-name=deconsample2cfRNA_deconv
#SBATCH --output=deconsample2cfRNA_deconv.out
#SBATCH --error=deconsample2cfRNA_deconv.err
#SBATCH --qos=normal
#SBATCH --ntasks=1
