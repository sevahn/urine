#!/bin/bash
#SBATCH --job-name=deconsample3cfRNA_deconv
#SBATCH --output=deconsample3cfRNA_deconv.out
#SBATCH --error=deconsample3cfRNA_deconv.err
#SBATCH --qos=normal
#SBATCH --ntasks=1
